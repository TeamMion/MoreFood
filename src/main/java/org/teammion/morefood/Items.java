...
import org.teammion.morefood.api.item.Item;
import org.teammion.morefood.api.item.ItemDrink;
import org.teammion.morefood.api.item.ItemFood;
import org.teammion.morefood.item.ItemMilkBottle;
import org.teammion.morefood.item.ItemStrawberry;
import org.teammion.morefood.item.ItemStrawberrySeed;
...
public class Items extends net.minecraft.init.Items
{
    ...
    public static final ItemStrawberrySeed STRAWBERRY_SEED = new ItemStrawberrySeed();
    ...
    public static void register()
    {
        ...
        Registry.register(STRAWBERRY_SEED);
    ...
    public static void registerModel()
    {
        ...
        Registry.registerModel(STRAWBERRY_SEED);
